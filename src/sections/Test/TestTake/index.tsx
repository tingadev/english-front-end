...
const TestTaken: React.FC<TestTakenProps> = ({ setIsTaken }) => {
  ...
  const questions = [
    {
      ...
      id: "1",
      text: '',
      question: 'Marketing specialists have conducted extensive studies of what	______ customers to a particular product.',
      answers: [
        {
          keyAnswer: "A",
          answer: "attractive",
    ...
    },
    {
      ...
      id: "2",
      text: '',
      question: 'Smart shoppers will _____ similar brands of an item before making a decision',
      answers: [
        {
          keyAnswer: "A",
          answer: "compare",
    ...
    },
    {
        ...
        id: "3",
        text: '',
        question: 'If our work isn’t to your ______, please notify US within 60 days.',
        answers: [
          {
            keyAnswer: "A",
            answer: "satisfy",
      ...
      },
      {
        ...
        id: "6",
        text: '',
        question: 'A careful analysis of the _______ products on the market indicated that our product lacked innovation and optional features',
        answers: [
          {
            keyAnswer: "A",
            answer: "compete",
      ...
      },
      {
        ...
        id: "11",
        text: ``,
        question: 'Which of the following might be part of the Catherine’s Curls line of products?',
        answers: [
          {
            keyAnswer: "A",
            answer: "Shampoo.",
      ...
      },
      {
        ...
        id: "12",
        text: ``,
        question: 'According to the report, why are fewer people buying Catherine’s Curls products?',
        answers: [
          {
            keyAnswer: "A",
      ...
      <Row>
        <Col md="8">
          {questions.map((question, index) => {
            return <QuestionItem questionProps={question} arrChecked={arrChecked} setArrChecked={setArrChecked} key={index} />;
          })}
